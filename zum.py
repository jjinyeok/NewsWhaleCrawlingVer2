...
article_title = response.xpath('/html/body/div[2]/div[1]/div[3]/div/article/header/h1/text()').extract()
...
article_reporter = ''.join(response.xpath('/html/body/div[2]/div[1]/div[3]/div/article/header/ul/li[2]/span/text()').extract())
article_url = link
aritcle_media_name = ''.join(response.xpath('/html/body/div[2]/div[1]/div[3]/div/article/header/p[1]/a/img/@alt').extract())
article_media_url = url + ''.join(response.xpath('/html/body/div[2]/div[1]/div[3]/div/article/header/p[1]/a/@href').extract())
article_media_image_src = ''.join(response.xpath('/html/body/div[2]/div[1]/div[3]/div/article/header/p[1]/a/img/@src').extract())
article_last_modified_date = response.xpath('/html/body/div[2]/div[1]/div[3]/div/article/header/ul/li/dl/dd/text()').extract()
